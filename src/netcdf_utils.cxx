...
void read_file_field_as_float(const char *file_name, const char *field_name, void **data_array_ptr, int *num_dims, int **dim_size_ptr, int *field_size)
{
                               ...
                               char *unit)
{
    ...
    *field_size = -1;
    ...
    for (i = 0; i < *num_dims; i ++)
        total_size *= dim_size[i];
    data_array = new double [total_size];
    rcode = nc_get_var(ncfile_id, variable_id, data_array);
...
void read_file_field_as_int(const char *file_name, const char *field_name, void **data_array_ptr, int *num_dims, int **dim_size_ptr, int *field_size,
                            char *unit)
{
    int i, ncfile_id, rcode, variable_id, *dim_ids, *dim_size;
    long total_size;
