...
class Triangle
{
    public:
        ...
        bool circumCircleContains(const Point<T> &v)
        {
...
{
    public:
        const std::vector<Triangle<T> >& triangulate(std::vector<Point<T> > &vertices)
        {
